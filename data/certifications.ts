...
const certifications: Certification[] = [
  {
    id: 1,
    title: 'Department Topper — BCA',
    issuer: 'Tilak Maharashtra Vidyapeeth',
    date: 'June 2025',
    credentialId: 'BCA · CGPA 8.30 / 10 · Navi Mumbai',
    url: 'https://drive.google.com/file/d/1SmIZ8QNzI2hJVVUpiR9p8ZB7W5r8GnY3/view?usp=sharing',
    color: '#FF5C39',
  },
  {
    id: 2,
